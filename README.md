...
I am using this repository to showcase projects for software engineering internship applications. Each project is organised as a concise case study with source code, design reasoning, technical highlights, and visual evidence of the final result.
