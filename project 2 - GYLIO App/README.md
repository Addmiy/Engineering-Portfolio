...
GYLIO, short for Get Your Life In Order, is a frontend productivity prototype built around a behavioural design brief: help users start their day with intentional action instead of distraction.
...
This project demonstrates my ability to interpret a product brief, design a clean user experience, implement interactive frontend behaviour with vanilla JavaScript, build responsive layouts with CSS, and organise a prototype so it can be reviewed by employers or extended in future versions.
